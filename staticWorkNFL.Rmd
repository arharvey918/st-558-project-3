...
# Build the classification tree model using default tuning grid (cp)
...
# Accuracy (cross-validation)
tree_fit$results$Accuracy

# Accuracy on holdout test data
get_test_accuracy(tree_fit, scoresTest)

# Do a prediction
predict(tree_fit, newdata = scoresTest %>% head(1))
```